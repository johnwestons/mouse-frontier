...
return {
    ...
    expeditionAreas = require("game.expedition_areas"),
    expeditionRuntime = require("game.expedition_runtime"),
    ...
    lastStandQuest = require("game.last_stand_quest"),
    lootProgression = require("game.loot_progression"),
    merchantTrade = require("game.merchant_trade"),
    ...
    roamingMobs = require("game.roaming_mobs"),
