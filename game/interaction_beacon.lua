...
local function setting(options, name)
    if options and options[name] ~= nil then
        return options[name] == true
    end
    return options and options.saveData and Accessibility.enabled(options.saveData, name) or false
end
...
function InteractionBeacon.drawUnderlay(selected, clock, options)
    ...
    love.graphics.setColor(palette.outline[1], palette.outline[2], palette.outline[3], highContrast and 0.94 or 0.70)
...
function InteractionBeacon.drawOverlay(selected, clock, options)
    ...
    love.graphics.setColor(palette.outline[1], palette.outline[2], palette.outline[3], highContrast and 0.96 or 0.80)
