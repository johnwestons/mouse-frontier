...
local definitions={
    ...
    story={
        ...
        E("story","family-8","LETTER IN A BOTTLE","A sealed bottle caught in desert reeds contains a note addressed to you.","story-b",3,{
            C("WADE INTO THE MARSH","Lose health; retrieve the letter and water.",{cost={health=1},reward={water=2}}),C("HOOK IT WITH WIRE","Spend scrap and preserve health.",{cost={scrap=2}}),C("TRACE THE RIVERBANK","Follow the bottle until it reaches shore.",{})},"Family clue: the trail continues west."),
