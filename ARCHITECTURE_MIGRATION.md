...
47. Garden rescue and wildlife-trough care extend the coordinator without adding world, HUD, input, or platform branches. Both reuse a small activity UI component for panels, sprite quadrants, hit targets, mistake feedback, and controls, while dedicated rule modules preserve independent gameplay and deterministic audits.
